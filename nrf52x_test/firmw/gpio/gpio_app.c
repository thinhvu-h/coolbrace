...
static void led_handler()
{
            ...
            (num_tick < PAIRABLE_ADV_TIMEOUT/LED_PAIR_TIMEOUT_MS))
    {
        ...
        nrf_gpio_pin_write(LED_PIN_1,LED_sync_status);
        nrf_gpio_pin_write(LED_PIN_2,LED_sync_status);
    } else {
...
void gpio_configure(void)
{
    ...
    nrf_gpio_cfg_output(HBRIGE_COOL_PIN);
    nrf_gpio_pin_clear(HBRIGE_COOL_PIN);
    nrf_gpio_cfg_output(HBRIGE_WARM_PIN);
